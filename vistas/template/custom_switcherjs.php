  ...
  <script>
     Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        window.location.href = `${window.location.host =='localhost' || es_numero(parseFloat(window.location.host)) == true ?`${window.location.origin}/gestion_turismo/vistas/`:window.location.origin}/vistas/`;
      } else {
